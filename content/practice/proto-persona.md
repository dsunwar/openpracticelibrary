...
* **Focus:**\
  Helps the team focus on the targeted users to solve the problem instead and not confuse the users as one of them from the team. 
...
* Finally, put it on the wall and discuss in a team on your findings to built a consensus. Agree collectively as a team on the persona that suits your project.
